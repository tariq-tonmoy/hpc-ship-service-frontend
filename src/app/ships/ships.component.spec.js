...
describe('ShipsComponent', function () {
    var component;
    var fixture;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        declarations: [ships_component_1.ShipsComponent]
                    })
                        .compileComponents()];
                case 1:
                    _a.sent();
    ...
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(ships_component_1.ShipsComponent);
